...
const [toggleMenu, setToggleMenu] = useState(false)
  ...
  return(
    ...
    <div className="app_navbar-smallscreen">
      <GiHamburgerMenu className='overlay_open' color="#fff" fontSize={27} onClick={() => setToggleMenu(true)}/>
{/* if toggleMenu is set to true then show this part of code  */}
      ...
      <div className="app_navbar-smallscreen_overlay flex_center slide-bottom">
        <MdOutlineRestaurant className='overlay_close' fontSize={27} onClick={() => setToggleMenu(false)}/>
